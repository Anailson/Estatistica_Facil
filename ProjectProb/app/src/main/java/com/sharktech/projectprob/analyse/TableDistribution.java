...
class TableDistribution {
    ...
    private static final float[] NORMAL_TABLE = {
            ...
            0.498134f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f,
            0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f,
            0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f, 0.498f,
    };
    private static final int NORMAL_SIZE = NORMAL_TABLE.length;
    private static final int NORMAL_COLUMN_SIZE = 10;
    private static final int NORMAL_ROW_SIZE = (int) Math.ceil(NORMAL_TABLE.length / NORMAL_COLUMN_SIZE);
    ...
    static float normal(float value) {
        ...
        for (int i = 0; i < NORMAL_SIZE; i++) {
            ...
            if(NORMAL_TABLE[i] >= value) {
                return valueOfIndex(value, i);
            }
        }
        return -1f;
    }
    ...
    private static float valueOfIndex(float value, int i){
        if(NORMAL_TABLE[i] == value) return valueOfIndex(row(i), col(i));
        else {

            int x = i - 1;
            float difMax = (NORMAL_TABLE[i] - value);
            float difMin = (value - NORMAL_TABLE[x]);
    ...
    private static int row(int index){
        return index / NORMAL_COLUMN_SIZE;
    }

    private static int col(int index){
        return index - (row(index) * NORMAL_COLUMN_SIZE);
    }
}
